    ...
    >
      <button
        ...
        style={{
          ...
          boxShadow: loading
            ? "none"
            : "0 0 22px rgba(63,114,175,0.3)",
          transition:
            "box-shadow 0.2s, background 0.3s, color 0.3s",
        }}
      >
        {children}
      </button>
      ...
      >
        <Box
          sx={{
            background: isDark
              ? "rgba(17,45,78,0.92)"
              : "rgba(249,247,247,0.97)",

            backdropFilter: "blur(32px)",

            border: `1px solid ${
              isDark
                ? "rgba(63,114,175,0.16)"
                : "rgba(63,114,175,0.2)"
            }`,
